...
const videoImports: VideoImports = {
  '0': () => import('@/assets/videos/showreel/001_ShowreelMiniCut.mp4'),
  '1': () => import('@/assets/videos/showreel/002_ShowreelMiniCut.mp4'),
  '2': () => import('@/assets/videos/showreel/003_ShowreelMiniCut.mp4'),
  '3': () => import('@/assets/videos/showreel/004_ShowreelMiniCut.mp4'),
  '4': () => import('@/assets/videos/showreel/005_ShowreelMiniCut.mp4'),
  '5': () => import('@/assets/videos/showreel/006_ShowreelMiniCut.mp4'),
  '6': () => import('@/assets/videos/showreel/007_ShowreelMiniCut.mp4'),
  '7': () => import('@/assets/videos/showreel/008_ShowreelMiniCut.mp4'),
  '8': () => import('@/assets/videos/showreel/009_ShowreelMiniCut.mp4'),
  '9': () => import('@/assets/videos/showreel/010_ShowreelMiniCut.mp4'),
  '10': () => import('@/assets/videos/showreel/011_ShowreelMiniCut.mp4'),
  '11': () => import('@/assets/videos/showreel/012_ShowreelMiniCut.mp4'),
  '12': () => import('@/assets/videos/showreel/013_ShowreelMiniCut.mp4'),
  '13': () => import('@/assets/videos/showreel/014_ShowreelMiniCut.mp4')
};
